...
//inclusão de dados
 ...
 "(nome, sobrenome, email, cpf, telefone, cep, rua, numero, bairro, cidade, estado, complemento, senha) 
 VALUES 
  ...
  $sql->bindValue(":C1", $novoNome);
    ...
    $sql->bindValue(":C6", $novoCep);
    $sql->bindValue(":C7", $novaRua);
    $sql->bindValue(":C8", $novoNumero);
